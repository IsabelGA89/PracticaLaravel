...
<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <div id="profile"
        ...
        <div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <p class="pt-8 text-sm">Desarrolladora Backend Junior, futura programadora full stack, lectora insaciable, y
                gran amante del conocimiento.</p>

            <div class="pt-12 pb-8">
                <button onclick="window.open('https://lectorainconforme.blogspot.com/');" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                    Visita mi blog
                </button>
            ...
            <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                <a class="link" target="_blank" href="https://twitter.com/Isa_Anzano" data-tippy-content="@twitter_handle">
                ...
                <a class="link" target="_blank" href="https://github.com/IsabelGA89" data-tippy-content="@github_handle">
                    <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" target="_blank" href="https://www.instagram.com/i.gonzalez/?hl=es" data-tippy-content="@instagram_handle">
                    <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" target="_blank" href="https://www.youtube.com/watch?v=zN9IrXQ5Yuk&t=1514s" data-tippy-content="@youtube_handle">
