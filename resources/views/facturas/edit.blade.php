...
@section("contenido")
    <div class="md:container md:mx-auto"><h1 class="text-4xl">Editar Factura {{$facturas}}</h1></div>
                ...
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                               name="empresa" type="text" placeholder="{{$facturas->empresa}}">
                    </div>
                    <div class="md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                               name="producto" placeholder="{{$facturas->producto}}" type="text">
                    </div>
                </div>
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/3 px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3"
                               name="unidades" type="number" placeholder="{{$facturas->unidades}}">
                    </div>
                    <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                               name="total" type="text" placeholder="{{$facturas->total}}">
                    </div>
                    ...
                    <div class="md:w-1/3 px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                               name="impuesto" type="text" placeholder="{{$facturas->impuesto}}">
                    </div>
                </div>
